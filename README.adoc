...
Kill Switch enabled features gets activated only if the related dependencies
are installed in PATH. These related dependencies are listed below as `🟢 Good
to have dependency`.
...
* 🔴 https://gcc.gnu.org/[*GCC*] or https://ziglang.org/[*Zig*]: For compiling treesitter language parsers
* 🔴 https://git-scm.com/[*git*]: For git integration, cloning plugin repos etc.
* 🔴 https://github.com/nodejs/node[*nodejs*]: For Language Servers and Formatters
* 🔴 https://github.com/tapio/live-server[*live-server*]: For local HTML Server
* 🟢 https://github.com/BurntSushi/ripgrep[*ripgrep*]: For live grep
* 🟢 https://github.com/sharkdp/fd[*fd*]: For Find Files
* 🟢 https://github.com/vifm/vifm[*vifm*]: File Manager
* 🟢 https://github.com/jesseduffield/lazygit[*lazygit*]: Git UI
* 🟢 https://github.com/kovidgoyal/kitty[*kitty*]: Kitty's Graphics Protocol for inline image/diagram rendering
* 🟢 https://github.com/mermaid-js/mermaid-cli[*mermaid-cli*]: For rendering inline Mermaid Diagrams
...
WARNING: Many core components are Linux centric.
~Features like image preview won't work and other features 100% will break on Windows currently.~
There's a full killswitch system which disables features safely based on the available requirements in PATH.
~And it's super hard to set up all the requirements on Windows.~
Use chocolatey or winget to install.
...
* Support for Matugen Dynamic Material You palette restricted to UI only
