...
| `ds <bracket>`           | [d]elete [s]urrounding <brackets>
| `cs <bracket>`           | [c]hange [s]urrounding <bracket> to <new-bracket>
| `cS <bracket>`           | [c]hange [s]urrounding <bracket> to <new-bracket> (line-wise)
| `gsl <bracket>`          | [g]o [s]urround this [l]ine with <bracket>
| `gsL <bracket>`          | [g]o [s]urround this [l]ine with <bracket> (line-wise)
| `gs <motions> <bracket>` | [g]o [s]urround this object with <bracket>
| `gS <motions> <bracket>` | [g]o [s]urround this object with <motions> <bracket> (line-wise)
|===
