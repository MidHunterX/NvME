...
* https://git-scm.com/[*git*]: For git integration and plugin manager | `lazy.nvim`

Installing the following dependencies activates plugins and features that require them:

* https://gcc.gnu.org/[*GCC*]: For compiling treesitter language parsers | `nvim-treesitter`
* https://github.com/tree-sitter/tree-sitter-cli[*tree-sitter-cli*]: Incremental language parsers | `nvim-treesitter`
...
* https://github.com/InioX/matugen[*matugen*]: For dynamic color support throughout the UI
