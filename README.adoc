...
WARNING: Many core components are Linux centric. Features like image preview
won't work and other features 100% will break on Windows currently. And it's
super hard to set up all the requirements on Windows. So, proceed only if you
are highly determined.
